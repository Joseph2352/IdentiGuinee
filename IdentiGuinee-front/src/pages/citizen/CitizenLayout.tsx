        ...
        <header className="h-16 bg-white border-b border-surface-variant/30 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30 shadow-sm shrink-0">
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <div>
              ...
              <nav aria-label="Breadcrumb" className="hidden sm:flex text-[10px] text-outline uppercase font-bold tracking-tighter">
            ...
            <div className="hidden xl:block relative w-72">
              ...
              <input 
                className="w-full bg-surface-container-low border-none rounded-full pl-10 h-10 text-xs focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-outline/50 font-medium" 
